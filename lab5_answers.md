...
2. When require_certificate is set to true, the broker enforces Mutual TLS.This means the connection will fail immediately if
...
3. One of the things Suricata can still observe is Server Name Indication and certificates. During the initial handshake, the
